    ...
    return (
        <div className="Home">
            ...
            <Container fluid className="mt-4">
                <Row>
                    <Col sm={4} md={3}><Button onClick={handleNewNote}>Yeni</Button>
                            ...
                            activeNote == null
                                ...
                                <Form>
                                    ...
                                    <Form.Group className="mb-3">
                                        <Form.Control as="textarea" placeholder="Content" rows={10} value={activeNote.content} onChange={handleContentChange}></Form.Control>
                                    </Form.Group>
                                    <div>
